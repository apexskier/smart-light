...
rgb_color interpolateColor(rgb_color from, rgb_color to, float percent) {
  ...
  // the hsv color model is easier to transition through
  ...
  if (from_hsv.h < to_hsv.h) {
    ...
    // colors wrapping around need to be handled differently
    // TODO: we need a way to specify that we're going the other direction?
...
// this is based off the svg generated by the sketch file in this dir
